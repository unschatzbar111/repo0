...
//makes the array containing grades in string format like A, B+, etc
...
return grades;//contains corresponding grade points
}
...
function calculate2NonELC(){
  ...
  const output = document.querySelector('#output');
  output.innerHTML = "Your SPI for Sem-I is : " + spi1 + "<br>Your SPI for Sem-II is : " + spi2 + "<br>Your CPI uptil Sem-II is : " +cpi;
}
